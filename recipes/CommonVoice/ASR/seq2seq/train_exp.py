...
if __name__ == "__main__":
    ...
    argvs = ['ASR/seq2seq/hparams/train_fr_exp.yml', '--batch_size=1', '--device=cuda:3']
    ...
    # Due to Distributed Data Parallel (DDP), we do the preparation ONLY on the main python process
    # run_on_main(
